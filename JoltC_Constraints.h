...
JOLTC_API void JPH_DistanceConstraint_SetLimitsSpringSettings(JPH_DistanceConstraint *constraint, JPH_SpringSettings limitsSpringSettings);
...
JOLTC_API void JPH_SixDOFConstraint_SetLimitsSpringSettings(JPH_SixDOFConstraint *constraint, JPH_SixDOFConstraintSettings_EAxis axis, JPH_SpringSettings limitsSpringSettings);
...
JOLTC_API void JPH_SliderConstraint_SetLimitsSpringSettings(JPH_SliderConstraint *constraint, JPH_SpringSettings limitsSpringSettings);

typedef struct JPH_SwingTwistConstraint {
    JPH_TwoBodyConstraint base;
} JPH_SwingTwistConstraint;

JOLTC_API JPH_Vec3 JPH_SwingTwistConstraint_GetLocalSpacePosition1(const JPH_SwingTwistConstraint *constraint);
JOLTC_API JPH_Vec3 JPH_SwingTwistConstraint_GetLocalSpacePosition2(const JPH_SwingTwistConstraint *constraint);
JOLTC_API JPH_Quat JPH_SwingTwistConstraint_GetConstraintToBody1(const JPH_SwingTwistConstraint *constraint);
JOLTC_API JPH_Quat JPH_SwingTwistConstraint_GetConstraintToBody2(const JPH_SwingTwistConstraint *constraint);
JOLTC_API float JPH_SwingTwistConstraint_GetNormalHalfConeAngle(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetNormalHalfConeAngle(JPH_SwingTwistConstraint *constraint, float angle);
JOLTC_API float JPH_SwingTwistConstraint_GetPlaneHalfConeAngle(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetPlaneHalfConeAngle(JPH_SwingTwistConstraint *constraint, float angle);
JOLTC_API float JPH_SwingTwistConstraint_GetTwistMinAngle(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetTwistMinAngle(JPH_SwingTwistConstraint *constraint, float angle);
JOLTC_API float JPH_SwingTwistConstraint_GetTwistMaxAngle(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetTwistMaxAngle(JPH_SwingTwistConstraint *constraint, float angle);
JOLTC_API const JPH_MotorSettings *JPH_SwingTwistConstraint_GetSwingMotorSettingsConst(const JPH_SwingTwistConstraint *constraint);
JOLTC_API JPH_MotorSettings *JPH_SwingTwistConstraint_GetSwingMotorSettings(JPH_SwingTwistConstraint *constraint);
JOLTC_API const JPH_MotorSettings *JPH_SwingTwistConstraint_GetTwistMotorSettingsConst(const JPH_SwingTwistConstraint *constraint);
JOLTC_API JPH_MotorSettings *JPH_SwingTwistConstraint_GetTwistMotorSettings(JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetMaxFrictionTorque(JPH_SwingTwistConstraint *constraint, float frictionTorque);
JOLTC_API float JPH_SwingTwistConstraint_GetMaxFrictionTorque(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetSwingMotorState(JPH_SwingTwistConstraint *constraint, JPH_EMotorState state);
JOLTC_API JPH_EMotorState JPH_SwingTwistConstraint_GetSwingMotorState(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetTwistMotorState(JPH_SwingTwistConstraint *constraint, JPH_EMotorState state);
JOLTC_API JPH_EMotorState JPH_SwingTwistConstraint_GetTwistMotorState(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetTargetAngularVelocityCS(JPH_SwingTwistConstraint *constraint, JPH_Vec3 angularVelocity);
JOLTC_API JPH_Vec3 JPH_SwingTwistConstraint_GetTargetAngularVelocityCS(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetTargetAngularVelocityBS(JPH_SwingTwistConstraint *constraint, JPH_Vec3 angularVelocity);
JOLTC_API void JPH_SwingTwistConstraint_SetTargetOrientationCS(JPH_SwingTwistConstraint *constraint, JPH_Quat orientation);
JOLTC_API JPH_Quat JPH_SwingTwistConstraint_GetTargetOrientationCS(const JPH_SwingTwistConstraint *constraint);
JOLTC_API void JPH_SwingTwistConstraint_SetTargetOrientationBS(JPH_SwingTwistConstraint *constraint, JPH_Quat orientation);
JOLTC_API JPH_Quat JPH_SwingTwistConstraint_GetRotationInConstraintSpace(const JPH_SwingTwistConstraint *constraint);
