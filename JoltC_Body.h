...
JOLTC_API const JPH_Body *JPH_BodyLockMultiRead_GetBody(const JPH_BodyLockMultiRead *lock, const JPH_BodyLockInterface *bodyLockInterface, int bodyIndex);
JOLTC_API JPH_Body *JPH_BodyLockMultiWrite_GetBody(const JPH_BodyLockMultiWrite *lock, const JPH_BodyLockInterface *bodyLockInterface, int bodyIndex);
...
JOLTC_API bool JPH_Body_IsSoftBody(const JPH_Body *body);
JOLTC_API bool JPH_Body_IsActive(const JPH_Body *body);
JOLTC_API bool JPH_Body_IsStatic(const JPH_Body *body);
JOLTC_API bool JPH_Body_IsKinematic(const JPH_Body *body);
JOLTC_API bool JPH_Body_IsDynamic(const JPH_Body *body);
JOLTC_API bool JPH_Body_CanBeKinematicOrDynamic(const JPH_Body *body);
JOLTC_API void JPH_Body_SetIsSensor(JPH_Body *body, bool isSensor);
JOLTC_API bool JPH_Body_IsSensor(const JPH_Body *body);
JOLTC_API void JPH_Body_SetCollideKinematicVsNonDynamic(JPH_Body *body, bool collide);
JOLTC_API bool JPH_Body_GetCollideKinematicVsNonDynamic(const JPH_Body *body);
JOLTC_API void JPH_Body_SetUseManifoldReduction(JPH_Body *body, bool useReduction);
JOLTC_API bool JPH_Body_GetUseManifoldReduction(const JPH_Body *body);
JOLTC_API bool JPH_Body_GetUseManifoldReductionWithBody(const JPH_Body *body, const JPH_Body *body2);
JOLTC_API void JPH_Body_SetApplyGyroscopicForce(JPH_Body *body, bool apply);
JOLTC_API bool JPH_Body_GetApplyGyroscopicForce(const JPH_Body *body);
JOLTC_API void JPH_Body_SetEnhancedInternalEdgeRemoval(JPH_Body *body, bool apply);
JOLTC_API bool JPH_Body_GetEnhancedInternalEdgeRemoval(const JPH_Body *body);
JOLTC_API bool JPH_Body_GetEnhancedInternalEdgeRemovalWithBody(const JPH_Body *body, const JPH_Body *body2);
JOLTC_API JPH_EMotionType JPH_Body_GetMotionType(const JPH_Body *body);
JOLTC_API void JPH_Body_SetMotionType(JPH_Body *body, JPH_EMotionType motionType);
JOLTC_API JPH_BroadPhaseLayer JPH_Body_GetBroadPhaseLayer(const JPH_Body *body);
JOLTC_API JPH_ObjectLayer JPH_Body_GetObjectLayer(const JPH_Body *body);
JOLTC_API const JPH_CollisionGroup *JPH_Body_GetCollisionGroupConst(const JPH_Body *body);
JOLTC_API JPH_CollisionGroup *JPH_Body_GetCollisionGroup(JPH_Body *body);
JOLTC_API void JPH_Body_SetCollisionGroup(JPH_Body *body, const JPH_CollisionGroup *group);
JOLTC_API bool JPH_Body_GetAllowSleeping(const JPH_Body *body);
JOLTC_API void JPH_Body_SetAllowSleeping(JPH_Body *body, bool allow);
JOLTC_API void JPH_Body_ResetSleepTimer(JPH_Body *body);
JOLTC_API float JPH_Body_GetFriction(const JPH_Body *body);
JOLTC_API void JPH_Body_SetFriction(JPH_Body *body, float friction);
JOLTC_API float JPH_Body_GetRestitution(const JPH_Body *body);
JOLTC_API void JPH_Body_SetRestitution(JPH_Body *body, float restitution);
JOLTC_API JPH_Vec3 JPH_Body_GetLinearVelocity(const JPH_Body *body);
JOLTC_API void JPH_Body_SetLinearVelocity(JPH_Body *body, JPH_Vec3 linearVelocity);
JOLTC_API void JPH_Body_SetLinearVelocityClamped(JPH_Body *body, JPH_Vec3 linearVelocity);
JOLTC_API JPH_Vec3 JPH_Body_GetAngularVelocity(const JPH_Body *body);
JOLTC_API void JPH_Body_SetAngularVelocity(JPH_Body *body, JPH_Vec3 angularVelocity);
JOLTC_API void JPH_Body_SetAngularVelocityClamped(JPH_Body *body, JPH_Vec3 angularVelocity);
JOLTC_API JPH_Vec3 JPH_Body_GetPointVelocityCOM(const JPH_Body *body, JPH_Vec3 pointRelativeToCOM);
JOLTC_API JPH_Vec3 JPH_Body_GetPointVelocity(const JPH_Body *body, JPH_RVec3 point);
JOLTC_API void JPH_Body_AddForce(JPH_Body *body, JPH_Vec3 force);
JOLTC_API void JPH_Body_AddForceAtPoint(JPH_Body *body, JPH_Vec3 force, JPH_RVec3 position);
JOLTC_API void JPH_Body_AddTorque(JPH_Body *body, JPH_Vec3 torque);
JOLTC_API JPH_Vec3 JPH_Body_GetAccumulatedForce(const JPH_Body *body);
JOLTC_API JPH_Vec3 JPH_Body_GetAccumulatedTorque(const JPH_Body *body);
JOLTC_API void JPH_Body_ResetForce(JPH_Body *body);
JOLTC_API void JPH_Body_ResetTorque(JPH_Body *body);
JOLTC_API void JPH_Body_ResetMotion(JPH_Body *body);
JOLTC_API JPH_Mat44 JPH_Body_GetInverseInertia(const JPH_Body *body);
JOLTC_API void JPH_Body_AddImpulse(JPH_Body *body, JPH_Vec3 impulse);
JOLTC_API void JPH_Body_AddImpulseAtPoint(JPH_Body *body, JPH_Vec3 impulse, JPH_RVec3 position);
JOLTC_API void JPH_Body_AddAngularImpulse(JPH_Body *body, JPH_Vec3 angularImpulse);
JOLTC_API void JPH_Body_MoveKinematic(JPH_Body *body, JPH_RVec3 targetPosition, JPH_Quat targetRotation, float deltaTime);
JOLTC_API void JPH_Body_GetSubmergedVolume(const JPH_Body *body, JPH_RVec3 surfacePosition, JPH_Vec3 surfaceNormal, float *outTotalVolume, float *outSubmergedVolume, JPH_Vec3 *outRelativeCenterOfBuoyancy);
JOLTC_API bool JPH_Body_ApplyBuoyancyImpulseWithSurface(JPH_Body *body, JPH_RVec3 surfacePosition, JPH_Vec3 surfaceNormal, float buoyancy, float linearDrag, float angularDrag, JPH_Vec3 fluidVelocity, JPH_Vec3 gravity, float deltaTime);
JOLTC_API bool JPH_Body_ApplyBuoyancyImpulse(JPH_Body *body, float totalVolume, float submergedVolume, JPH_Vec3 relativeCenterOfBuoyancy, float buoyancy, float linearDrag, float angularDrag, JPH_Vec3 fluidVelocity, JPH_Vec3 gravity, float deltaTime);
JOLTC_API bool JPH_Body_IsInBroadPhase(const JPH_Body *body);
JOLTC_API bool JPH_Body_IsCollisionCacheInvalid(const JPH_Body *body);
JOLTC_API const JPH_Shape *JPH_Body_GetShape(const JPH_Body *body);
JOLTC_API JPH_RVec3 JPH_Body_GetPosition(const JPH_Body *body);
JOLTC_API JPH_Quat JPH_Body_GetRotation(const JPH_Body *body);
JOLTC_API JPH_RMat44 JPH_Body_GetWorldTransform(const JPH_Body *body);
JOLTC_API JPH_RVec3 JPH_Body_GetCenterOfMassPosition(const JPH_Body *body);
JOLTC_API JPH_RMat44 JPH_Body_GetCenterOfMassTransform(const JPH_Body *body);
JOLTC_API JPH_RMat44 JPH_Body_GetInverseCenterOfMassTransform(const JPH_Body *body);
JOLTC_API JPH_AABox JPH_Body_GetWorldSpaceBounds(const JPH_Body *body);
JOLTC_API const JPH_MotionProperties *JPH_Body_GetMotionPropertiesConst(const JPH_Body *body);
JOLTC_API JPH_MotionProperties *JPH_Body_GetMotionProperties(JPH_Body *body);
JOLTC_API const JPH_MotionProperties *JPH_Body_GetMotionPropertiesUncheckedConst(const JPH_Body *body);
JOLTC_API JPH_MotionProperties *JPH_Body_GetMotionPropertiesUnchecked(JPH_Body *body);
...
JOLTC_API void JPH_Body_ApplySoftBodyCreationSettings(JPH_Body *body, const JPH_SoftBodyCreationSettings *softBodyCreationSettings, const JPH_BroadPhaseLayerInterface *bplInterface);
